...
# =============================================================================
# Helper: Create standard panel StyleBox
# =============================================================================
static func make_panel_style() -> StyleBoxFlat:
	...
	sb.border_width_bottom = PANEL_BORDER_WIDTH + PANEL_BOTTOM_BAR
...
# =============================================================================
# Helper: Create green button StyleBox
# =============================================================================
static func make_button_style_normal() -> StyleBoxFlat:
	...
	sb.border_width_bottom = BUTTON_BORDER_BOTTOM + 3
...
# =============================================================================
static func make_pill_style(bg_color: Color, border_color: Color) -> StyleBoxFlat:
	var sb := StyleBoxFlat.new()
...
# =============================================================================
# Helper: Create progress track StyleBox (inset shadow simulated)
# =============================================================================
